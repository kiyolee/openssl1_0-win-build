#ifndef KL_OSSL10_BUILD
  #ifdef _WIN64
  #error "Windows build (PLATFORM=VC-WIN64A) using https://github.com/kiyolee/openssl1_0-win-build.git."
  #else
  #error "Windows build (PLATFORM=VC-WIN32) using https://github.com/kiyolee/openssl1_0-win-build.git."
  #endif
#endif
...
#endif
#ifdef OPENSSL_SYSNAME_WIN64
#define CFLAG_DEF_OPENSSL_SYSNAME_WIN64 " -DOPENSSL_SYSNAME_WIN64"
#else
#define CFLAG_DEF_OPENSSL_SYSNAME_WIN64 ""
#endif
...
#define CFLAGS_DEFS \
   ...
   CFLAG_DEF_OPENSSL_SYSNAME_WIN64 \
